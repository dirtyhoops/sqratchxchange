    ...
    <section className='section-about' ref={sectionRef}>
      <div className='about container'>
        <div className='about__container'>
          <div className='about__container--left fadeIn1 animation-position'>
          ...
          <div className='about__container--right'>
            <div className='about__text'>
              <h2 className='heading-primary fadeIn1 animation-position'>
                About Sqratch Xchange
              </h2>
              <p className='text--about fadeIn1 animation-position'>
